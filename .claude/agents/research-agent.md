---
# AUTO-SYNCED from .github/agents/research-agent.agent.md — do not edit directly
...
# Normalized by /sync-agents from unsupported source model: Gemini 3 Flash (Preview) (copilot)
model: sonnet
