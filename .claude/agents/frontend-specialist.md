---
# AUTO-SYNCED from .github/agents/frontend-specialist.agent.md — do not edit directly
...
# Normalized by /sync-agents from unsupported source model: Gemini 3.1 Pro (Preview) (copilot)
model: sonnet
