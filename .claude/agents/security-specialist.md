---
# AUTO-SYNCED from .github/agents/security-specialist.agent.md — do not edit directly
...
# Normalized by /sync-agents from unsupported source model: GPT-5.3-Codex (copilot)
model: sonnet
